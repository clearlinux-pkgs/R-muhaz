...
Version  : 1.2.6.2
Release  : 20
URL      : https://cran.r-project.org/src/contrib/muhaz_1.2.6.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/muhaz_1.2.6.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617118249
